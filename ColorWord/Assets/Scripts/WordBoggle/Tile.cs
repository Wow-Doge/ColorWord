...
public class Tile : MonoBehaviour {
	...
	public void SetTileData (char c) 
	{
		...
		type = index;
		//set tile background to color black
		tileBg.GetComponent<Renderer> ().material.color =  normalBackgroundColor;
	...
	//change the color of a tile when it is selected
	public void Select (bool value)
	{
		selected = value;
		
		if (selected) {
			tileBg.GetComponent<Renderer> ().material.color = clickedBackgroundColor;
